<div>
    ...
    <form wire:submit.prevent="save" class="bg-white p-4 rounded shadow mt-4">
        <div class="mb-2">
            ...
            <input wire:model.defer="nome" class="mt-1 block w-full border rounded px-3 py-2">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input wire:model.defer="telefone" class="mt-1 block w-full border rounded px-3 py-2">
            </div>
        </div>
        ...
        @if($type === 'cliente')
            <div class="mt-4">
                ...
                <input wire:model.defer="cpf_cnpj" class="mt-1 block w-full border rounded px-3 py-2">
            </div>
        @else
            <div class="mt-4">
                <label class="block text-sm font-medium">Tipo</label>
                <select wire:model="tipo" class="mt-1 block w-full border rounded px-3 py-2">
            ...
            <div class="mt-4">
                ...
                <input wire:model.defer="razao_social" class="mt-1 block w-full border rounded px-3 py-2">
            </div>

            <div class="grid grid-cols-2 gap-4 mt-4">
                <div>
                    <label class="block text-sm font-medium">CNPJ/CPF</label>
                    <input wire:model.defer="cnpj_cpf" class="mt-1 block w-full border rounded px-3 py-2">
                </div>

                <div>
                    <label class="block text-sm font-medium">Percentual Comissão</label>
                    <input wire:model.defer="percentual_comissao" class="mt-1 block w-full border rounded px-3 py-2">
                </div>
            </div>
        @endif
