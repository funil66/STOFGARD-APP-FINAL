            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-start gap-3 p-4 bg-success-50 dark:bg-success-950 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-success-700 dark:text-success-400 mt-1">Calendário e sincronização Google</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 p-4 bg-success-50 dark:bg-success-950 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-success-700 dark:text-success-400 mt-1">Gestão de parceiros e comissões</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 p-4 bg-success-50 dark:bg-success-950 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-success-700 dark:text-success-400 mt-1">Controle de receitas e despesas</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 p-4 bg-success-50 dark:bg-success-950 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-success-700 dark:text-success-400 mt-1">Estoque, produtos e movimentações</p>
                    </div>
                </div>
            </div>
        </x-filament::section>
                ...
                <div class="flex items-start justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Sincronização automática de agendamentos</p>
                            <a href="{{ route('filament.admin.pages.google-calendar-settings') }}" class="text-sm text-primary-600 hover:text-primary-700 mt-2 inline-block">
                                Configurar integração →
                            </a>
                        </div>
                    </div>
                    <span class="px-3 py-1 text-xs font-medium bg-success-100 text-success-800 dark:bg-success-900 dark:text-success-300 rounded-full">
                        Disponível
                    </span>
                </div>
            </div>
        ...
        <x-filament::section>
            ...
            <div class="prose dark:prose-invert max-w-none">
                <p class="text-gray-700 dark:text-gray-300">
                    O <strong>Sistema Stofgard 2026</strong> é uma solução completa para gestão de empresas de impermeabilização e higienização. 
                    Desenvolvido com tecnologias modernas (Laravel + Filament), oferece controle total sobre clientes, ordens de serviço, 
                    agendamentos, orçamentos, financeiro e estoque.
                </p>
                
                <div class="mt-4 p-4 bg-primary-50 dark:bg-primary-950 rounded-lg border border-primary-200 dark:border-primary-800">
