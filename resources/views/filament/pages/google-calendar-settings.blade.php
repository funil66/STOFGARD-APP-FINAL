            ...
            <x-filament::section>
                <x-slot name="heading">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-success-600 dark:text-success-400 font-semibold">Conectado ao Google Calendar</span>
                    </div>
                </x-slot>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3 p-4 bg-success-50 dark:bg-success-950 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-success-700 dark:text-success-400 mt-1">
                                Todos os seus agendamentos serão sincronizados automaticamente com o Google Calendar. Qualquer alteração feita aqui será refletida no Google Calendar e vice-versa.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $token->updated_at->diffForHumans() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            <li class="flex items-start gap-2">
                                ...
                                <span><strong>Sincronização automática:</strong> Seus agendamentos aparecem automaticamente no Google Calendar</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-4 h-4 text-primary-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span><strong>Acesso móvel:</strong> Visualize seus compromissos em qualquer dispositivo</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-4 h-4 text-primary-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            ...
                            <li class="flex items-start gap-2">
                                ...
                                <span><strong>Compartilhamento:</strong> Facilite o compartilhamento de agendas com sua equipe</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-4 h-4 text-primary-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span><strong>Backup automático:</strong> Seus agendamentos ficam salvos na nuvem do Google</span>
                            </li>
                        </ul>
                    </div>
