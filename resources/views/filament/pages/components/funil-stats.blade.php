...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-xl shadow-md border-2 border-blue-200 dark:border-blue-800">
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-xl shadow-md border-2 border-green-200 dark:border-green-800">
            <div class="flex items-center justify-between mb-2">
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 p-6 rounded-xl shadow-md border-2 border-yellow-200 dark:border-yellow-800">
            <div class="flex items-center justify-between mb-2">
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-xl shadow-md border-2 border-purple-200 dark:border-purple-800">
            <div class="flex items-center justify-between mb-2">
            ...
            <p class="text-3xl font-bold text-purple-900 dark:text-purple-100">
                R$ {{ $orcamentos->count() > 0 ? number_format($orcamentos->avg('valor_total'), 2, ',', '.') : '0,00' }}
            </p>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="space-y-2">
            @foreach($orcamentos->sortByDesc('valor_total')->take(5) as $orc)
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 dark:text-white">{{ $orc->cliente->nome ?? 'N/A' }}</p>
                        <p class="text-xs text-gray-500">{{ $orc->numero }} • {{ $statuses[$orc->etapa_funil]['title'] }}</p>
                    </div>
