                    ...
                    default => '#2563eb'
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex items-start gap-4 flex-1">
                                    {{-- Ícone --}}
                                    <div class="flex-shrink-0 h-12 w-12 rounded-full flex items-center justify-center" style="background: {{ match ($notification->type) {
                    'success' => '#d1fae5',
                    'warning' => '#fed7aa',
                    'danger' => '#fee2e2',
                    default => '#dbeafe'
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-4 text-xs" style="color: #9ca3af;">
                                            ...
                                            @if($notification->action_url)
                                                <a href="{{ $notification->action_url }}" class="hover:underline font-medium"
                                                    style="color: #2563eb;">
