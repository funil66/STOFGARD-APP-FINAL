...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            ...
            @if (file_exists(public_path('downloads/stofgard.apk')))
                <div class="mt-4 text-center w-full">
                    <a href="{{ asset('downloads/stofgard.apk') }}?v={{ filemtime(public_path('downloads/stofgard.apk')) }}"
                        class="inline-block px-6 py-2 bg-[#d97706] text-white rounded-md font-medium" download>
                        📲 Baixar APK Stofgard (Android)
                    </a>
                    <p class="text-sm text-gray-500 mt-2">Instale manualmente no Android. Habilite "Fontes desconhecidas" nas
                        configurações, se necessário.</p>
                </div>
            @endif
        @endif
    </header>
    @if (file_exists(public_path('downloads/stofgard.apk')))
        <div class="mt-4 text-center w-full">
            <a href="{{ asset('downloads/stofgard.apk') }}?v={{ filemtime(public_path('downloads/stofgard.apk')) }}"
                class="inline-block px-6 py-2 bg-[#d97706] text-white rounded-md font-medium" download>📲 Baixar APK
                Stofgard (Android)</a>
            <p class="text-sm text-gray-500 mt-2">Instale manualmente no Android. Habilite "Fontes desconhecidas" nas
                configurações, se necessário.</p>
        </div>
