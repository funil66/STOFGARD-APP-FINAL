...
class OrdemServico extends Model implements HasMedia, \OwenIt\Auditing\Contracts\Auditable
{
    ...
    protected $fillable = [
        ...
        'assinatura_hash',
        'assinatura_tecnico',
        'assinatura_tecnico_metadata',
        'assinatura_tecnico_pdf_hash',
        'assinado_tecnico_em',
    ...
    protected $casts = [
        ...
        'checkin_at' => 'datetime',
        'assinatura_metadata' => 'array',
        'assinado_em' => 'datetime',
        'assinatura_timestamp' => 'datetime',
        'assinatura_tecnico_metadata' => 'array',
        'assinado_tecnico_em' => 'datetime',
        'assinatura_tecnico_timestamp' => 'datetime',
