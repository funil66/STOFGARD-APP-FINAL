...
class VerifySystemIntegrity extends Command
{
     ...
     */
    public function handle(AutonomiaSystem $system)
    {
        ...
        try {
            ...
            // 3. Approve Orcamento (Triggers AutonomiaSystem)
            ...
            // Note: AutonomiaSystem::confirmarPagamento sets status to 'em_execucao' if OS exists
