...
A Stofgard utiliza a Evolution API para automatizar fluxos de disparo de mensagens do Funil de Vendas e cobranças financeiras.
...
EVOLUTION_INSTANCE_NAME=stofgard_padrao
