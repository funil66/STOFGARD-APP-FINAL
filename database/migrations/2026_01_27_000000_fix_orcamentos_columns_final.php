    ...
    public function up(): void
    {
        Schema::table('orcamentos', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('orcamentos', 'cliente_id')) {
                ...
                // Tenta dropar chave estrangeira se existir primeiro
                try {
                    $table->dropForeign(['cliente_id']);
                } catch (\Throwable $e) {
                    \Log::warning('Failed to drop foreign key for cliente_id: ' . $e->getMessage());
                }
                ...
                if (Schema::hasIndex('orcamentos', 'orcamentos_cliente_id_index')) {
                    try {
                        ...
                        \Log::warning('Failed to drop index for cliente_id: ' . $e->getMessage());
                    }
                }
